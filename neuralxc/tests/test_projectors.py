...
@pytest.mark.fast
@pytest.mark.project
@pytest.mark.parametrize('grid_type', ['euclidean', 'radial'])
...
def test_jacobs_projector(rad_type, grid_type):
    ...
    basis_instructions = ConfigFile({"engine":
        {"application": application},
        "preprocessor": basis_instructions})['preprocessor']
...
def test_radial_projector():
    ...
    basis_instructions = {'basis': {'O': {'n': 2, 'l': 3, 'r_o': 1}, 'H': {'n': 2, 'l': 2, 'r_o': 1.5}},
...
def test_radial_gaussian():
    ...
    basis_instructions = {"basis": {"file": os.path.join(test_dir, "basis-test")},
     'projector': 'gaussian','grid' :'analytical'}
    ...
    basis_instructions = {"basis": {"file": os.path.join(test_dir, "basis-test"), 'sigma': 20},
     'projector': 'gaussian','grid' :'radial'}
...
def test_gaussian_projector(torch=''):
    ...
    basis_instructions = {"basis": {"file": os.path.join(test_dir, "basis-test"), 'sigma': 2},
     'projector': 'gaussian','grid' :'euclidean'}
