...
python ../../../helper_scripts/apply_subset.py benzene_ccsd_t-train.xyz ../../../configs/sGDML/benzene/10.csv train.traj
python ../../../helper_scripts/apply_subset.py benzene_ccsd_t-test.xyz test_subset.csv testing.traj
...
python ../../../helper_scripts/fix_paths.py
